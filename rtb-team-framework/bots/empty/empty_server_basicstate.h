/************************************************************************
    $Id: empty_server_basicstate.h,v 1.2 2005/02/24 10:27:53 jonico Exp $
    ...
    $Log: empty_server_basicstate.h,v $
...
#ifndef empty_SERVERBASICSTATE_H
#define empty_SERVERBASICSTATE_H
...
/**
 *	This class is the base of all empty server states. Here, the default actions, that will be done by every state
 ...
 */
	...
	class empty_ServerBasicState: public Strategies::ServerState {
	public:
		empty_ServerBasicState(ServerCoordinator* i, empty_InternalServerSpecificRepository* empty_issp, empty_SharedServerSpecificRepository* empty_sharedssp); //throw (StrategyException,bad_exception);
		virtual ~empty_ServerBasicState () throw();
