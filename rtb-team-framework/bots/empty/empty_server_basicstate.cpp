/************************************************************************
    $Id: empty_server_basicstate.cpp,v 1.2 2005/02/24 10:27:53 jonico Exp $
    ...
    $Log: empty_server_basicstate.cpp,v $
...
namespace empty {
	empty_ServerBasicState::empty_ServerBasicState(ServerCoordinator* i, empty_InternalServerSpecificRepository* empty_issp, empty_SharedServerSpecificRepository* empty_sharedssp) /*throw (StrategyException,bad_exception)*/: ServerState(i) {}

	empty_ServerBasicState::~empty_ServerBasicState () throw() {}

	/**
	 * This method is called from the coordinator's processReceivedRTBMessages method and should send tips to the clients.
	 */
	void empty_ServerBasicState::sendServerTips () {} //throw (StrategyException,bad_exception) {}


	/**
	* This method is called by ServerCoordinatorRevokes::resetGame()
	*/
	void empty_ServerBasicState::reset () {} //throw (bad_exception, StrategyException) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageRadar(double dist,object_type type,double angle) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageInfo(double time,double speed,double cannonAngle) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageCoordinates(double x,double y,double angle) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageRobotInfo(double energy,bool isTeamMate) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageRotationReached(int what) {} //throw (StrategyException, bad_exception) {}	// >> Maybe we should introduce another
									//    enum for this (TODO)
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageEnergy(double energy) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageRobotsLeft(int num) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageCollision(object_type type,double angle) {} //throw (StrategyException, bad_exception) {}
	...
	*/
	void empty_ServerBasicState::receiveRTBMessageWarning(warning_type warning,const string& message) {} //throw (StrategyException, bad_exception) {}

	/**
	* This method is called when the RTB message "Dead" occurs. This message is sent when the robot pegs out.
	*/
	void empty_ServerBasicState::receiveRTBMessageDead() {} //throw (StrategyException, bad_exception) {}
}
