/************************************************************************
    $Id: empty_client_basicstate.h,v 1.2 2005/02/24 10:27:53 jonico Exp $
    ...
    $Log: empty_client_basicstate.h,v $
...
#ifndef empty_CLIENTBASICSTATE_H
#define empty_CLIENTBASICSTATE_H
...
/**
 *	This class is the base of all empty client states. Here, the default actions, that will be done by every state
 ...
 *
 */
	class empty_ClientBasicState: public Strategies::ClientState {
	public:
		empty_ClientBasicState(ClientCoordinator* i, empty_ClientSpecificRepository* empty_csp, const GameOptionsRepository* empty_gor); //throw (StrategyException,bad_exception);
		virtual  ~empty_ClientBasicState () throw();
