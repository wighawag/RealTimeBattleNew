...
public:
	...
	*/
	 ...
	 */
	virtual void reset () = 0; //throw (bad_exception, StrategyException) = 0;
	 ...
	 */
	virtual void receiveRTBMessageRotationReached(int what) = 0; //throw (StrategyException, bad_exception) = 0;	// >> Maybe we should introduce another
									//    enum for this (TODO)
	 ...
	 */
	virtual void receiveRTBMessageRobotsLeft(int num) = 0; //throw (StrategyException, bad_exception) = 0;
