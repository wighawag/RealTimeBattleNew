/************************************************************************
    $Id: coordinator.h,v 1.2 2005/02/24 10:27:53 jonico Exp $
...
namespace GameControl {
	...
	*/
	...
	public:
		...
		*/
		virtual void resetGame () = 0; //throw (StrategyException,bad_exception) = 0;
		...
		*/
		virtual void processReceivedRTBMessages () = 0; //throw (StrategyException,bad_exception) = 0;
		virtual string  getAssociatedRobotName () = 0; //throw (bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageRadar(double dist,object_type type,double angle) = 0; //throw (StrategyException, bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageInfo(double time,double speed,double cannonAngle) = 0; //throw (StrategyException, bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageCoordinates(double x,double y,double angle) = 0; //throw (StrategyException, bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageRobotInfo(double energy,bool isTeamMate) = 0; //throw (StrategyException, bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageRotationReached(int what) = 0; //throw (StrategyException, bad_exception) = 0;	// >> Maybe we should introduce
		...
		*/
		virtual void receiveRTBMessageEnergy(double energy) = 0; //throw (StrategyException, bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageCollision(object_type type,double angle) = 0; //throw (StrategyException, bad_exception) = 0;
		...
		*/
		virtual void receiveRTBMessageWarning(warning_type warning,const string& message) = 0; //throw (StrategyException, bad_exception) = 0;

		/**
		* This method is called when the RTB message "Dead" occurs. This message is sent when the robot pegs out.
		*/
		virtual void receiveRTBMessageDead() = 0; //throw (StrategyException, bad_exception) = 0;
	protected:
	};
