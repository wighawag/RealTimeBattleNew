/************************************************************************
    $Id: coordinatorcomposite.h,v 1.2 2005/02/24 10:27:53 jonico Exp $
...
#ifndef COORDINATORCOMPOSITE_H
#define COORDINATORCOMPOSITE_H
...
* This class was specially designed for combining the local ServerCoordinator and the
* LocalClientCoordinator in order not to have a distinction between local and remote clients.
*
* TODO: Add all receiveRTBMessages to this class
* IMPORTANT: Coordinator objects are deleted by the controller and NOT by this class
*/
class CoordinatorComposite : public Coordinator {
/*
* Public stuff
*/
public:
